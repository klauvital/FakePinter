...
from fakepinter import app, database, bcrypt
from fakepinter.models import Usuario, Foto
from flask_login import login_required, login_user, logout_user, current_user
from fakepinter.forms import FormLogin, FormCriarConta, FormFoto
import os
...
def criarconta():
    ...
    if form_criarconta.validate_on_submit():
        ...
        bcrypt.check_password_hash(senha, form_criarconta.senha.data)
...
@login_required
def feed():
    fotos = Foto.query.order_by(Foto.data_criacao.desc()).all()[:8] #as oito priimeiras fotos
